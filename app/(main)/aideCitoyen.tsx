...
const usageTips = [
  {
    id: 1,
    title: 'Consultez vos réclamations',
    icon: 'description',
    description: 'Accédez à la liste de vos réclamations et ajouter une autre et à venir depuis le menu principal.'
  },
  {
    id: 2,
    title: 'Rédigez vos plaintes',
    icon: 'description',
    description: 'Ajouter et soumettez vos plaintes d\'intervention directement depuis l\'application.'
  },
  {
    id: 3,
    title: 'Gérez votre profil',
    icon: 'inventory',
    description: 'Consultez et modifier votre profil depuis la menu fournir dans la page d`accueil.'
  },
  {
    id: 4,
    title: 'Notifications importantes',
    icon: 'notifications',
    description: 'Restez informé des nouvelles plainte verifier.'
  }
];
...
const faqs = [
  ...
  {
    id: 3,
    question: 'Comment rédiger un palintes  ?',
    answer: 'Accéder a la page de ajouter nouvelle plainte et saisir tout les champs avec leur contenu .'
  },
